...
type Exam = { id: string; title: string; subject: string; durationMinutes: number; joinCode: string; questions: Question[] };
      ...
      <div className="flex-1 flex flex-col lg:flex-row max-w-5xl mx-auto w-full p-4 gap-5 pt-6">
        ...
        <div className="flex-1">
          <div className="bg-white rounded-xl border border-[#E2E8F0] p-6 mb-4 animate-fade-in" key={question.id}>
            <div className="flex items-center gap-2 mb-4">
              <span className="text-xs font-semibold text-white bg-[#2563EB] px-2.5 py-1 rounded-md">
                Câu {question.order}/{exam.questions.length}
              </span>
              {answers[question.id] && (
                <span className="text-xs font-semibold text-[#16A34A] bg-[#F0FDF4] px-2 py-1 rounded-md flex items-center gap-1">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selected
                        ...
                        : "border-[#E2E8F0] bg-white text-[#334155] hover:border-[#2563EB]/40 hover:bg-[#F8FAFC]"
                    )}
                  >
                    <span className={cn(
          ...
          <div className="flex items-center justify-between">
            ...
            {current < exam.questions.length - 1 ? (
              ...
              <Button onClick={() => submitExam(false)} loading={submitting} icon={<Send size={16} />}>
                Nộp bài
              </Button>
            )}
          </div>
        ...
        <aside className="lg:w-56 lg:shrink-0">
          <div className="bg-white rounded-xl border border-[#E2E8F0] p-4 lg:sticky lg:top-24">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      answered ? "bg-[#F0FDF4] text-[#16A34A] border border-[#BBF7D0]" :
                      "bg-[#F8FAFC] text-[#94A3B8] border border-[#E2E8F0] hover:border-[#2563EB]/40"
                    )}
                  >
                    {i + 1}
                  </button>
            ...
            <Button onClick={() => submitExam(false)} loading={submitting} className="w-full" size="sm">
              Nộp bài
            </Button>
          </div>
        </aside>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full animate-fade-in">
            ...
            <p className="text-sm text-[#64748B] mb-5">
              Bạn còn <strong>{exam.questions.length - answeredCount} câu</strong> chưa trả lời. Vẫn nộp bài?
            </p>
