    ...
    <div className="p-4 lg:p-8 max-w-5xl mx-auto">
      ...
      <div className="flex gap-2 mb-4 flex-wrap">
        <button
          ...
          className={`rounded-lg px-3 py-1.5 text-xs font-bold ${filter === "" ? "bg-[#6C63FF] text-white" : "bg-[var(--surface-card)] border border-[var(--surface-border)] text-[var(--text-secondary)]"}`}
        >
          Tất cả
        </button>
        {types.map((t) => (
          <button
            ...
            className={`rounded-lg px-3 py-1.5 text-xs font-bold ${filter === t.type ? "bg-[#6C63FF] text-white" : "bg-[var(--surface-card)] border border-[var(--surface-border)] text-[var(--text-secondary)]"}`}
          >
